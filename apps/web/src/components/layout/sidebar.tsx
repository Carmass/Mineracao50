...
export function DashboardSidebar() {
  ...
  return (
    <motion.aside
      ...
      className="relative flex flex-col bg-[#0a0b0e] border-r border-white/5 h-full overflow-hidden"
    >
      {/* Logo */}
      ...
      <button
        ...
        className="absolute top-4 -right-3 w-6 h-6 rounded-full bg-[#0a0b0e] border border-white/10 flex items-center justify-center text-white/40 hover:text-white/70 transition-colors z-10"
      >
